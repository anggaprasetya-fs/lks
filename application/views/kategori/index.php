            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?=base_url('Kategori/Add')?>" class="btn btn-success"><i class="fas fa-plus"></i> Add Data</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td width="200px"><?=$data->nama_kategori?></td>
                                        <td width="150px" class="text-center">
                                            <a href="<?=base_url('Kategori/edit/'.$data->id_kategori)?>" type="submit" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                                            <a href="<?=base_url('Kategori/delete/'.$data->id_kategori)?>" type="submit" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
